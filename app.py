...
def main():
    ...
    st.markdown("<h1 style='text-align: center;'>JSON Formatter</h1>", unsafe_allow_html=True)
    ...
    with col1:
        st.markdown("<h1 style='text-align: center;'>Input JSON</h1>", unsafe_allow_html=True)
